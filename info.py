...
PICS = (environ.get('PICS', 'https://i.imghippo.com/files/bsZI3590NbY.jpg https://i.imghippo.com/files/Ga3992XgQ.jpg https://i.imghippo.com/files/pPk3273Kmo.jpg')).split()  # Sample pic
...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/7478ff3eac37f4329c3d8.jpg https://i.imghippo.com/files/oUyy1541rKc.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6317211079').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002483175670').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002421781174'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002421781174'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002301268603'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002464620680'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002178835257')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002482928144').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002219563250')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002219563250')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002178835257').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002178835257').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/mslanderstalk_bot')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@MSLANDERSTALK_BOT')
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/msrequest_group')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/msrequest_group')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/msrequest_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mslanders')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MslandersTalk_bot')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/MOVIEUPDATE_CHANNEL')
OWNERID = int(os.environ.get('OWNERID', '6317211079'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6317211079').split()]
