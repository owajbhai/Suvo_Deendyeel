...
PICS = (environ.get('PICS', 'https://telegra.ph/file/2e6547ab07940cc3ef3ea-cc7f38c48bd28576d2.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://telegra.ph/file/378a08d7e1bca338db963-d05a2ded13e2ffa4dd.jpg'))
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002374561171')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002074744533')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002374561171') #Channel / Group Id for force sub ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a0c2399faba751854a84f02bb564d6d8f36497f2')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+sfVlEyOyPWo5MzZl')
