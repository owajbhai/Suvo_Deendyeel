...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ROYALBOMMA:ROYALBOMMA766@royalbomma.bomyg.mongodb.net/?retryWrites=true&w=majority&appName=ROYALBOMMA")
