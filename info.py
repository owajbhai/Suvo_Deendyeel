...
API_ID = int(environ.get('API_ID', '21180955'))
API_HASH = environ.get('API_HASH', '5006e4600663a88cd7cb42617b1bb61a')
BOT_TOKEN = environ.get('BOT_TOKEN', "8093755719:AAGhlvcAmoyIlRBP7uGR0IgTCjdJIGkpkNI")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7724838876').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002270564015'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002270564015'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002075397287'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002270564015'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002399713326').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001937695139').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001937695139').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/Akh.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'royals9391@ibl')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://royalsrikanth635:<Xqi1ubmJQUKYoIyt>@cluster0.osde5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://royalsrikanth635:<Xqi1ubmJQUKYoIyt>@cluster0.osde5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "royalsrikanth635")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ROYALBOMMA')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002270564015'))  # Log channel id (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+9a7WaNIEhlM2NmQ1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ROYALBOMMA')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ROYALBOMMA')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/ROYALBOMMA')
OWNERID = int(os.environ.get('OWNERID', '7724838876'))  # Replace with the actual admin ID
