        ...
        if channels:  
            ...
            if btn:
                ...
                caption = (
                    ...
                    "🎬 ᴛᴏ ɢᴇᴛ ᴛʜᴇ ᴍᴏᴠɪᴇ ʏᴏᴜ ʀᴇǫᴜᴇsᴛᴇᴅ, ʏᴏᴜ ᴍᴜsᴛ ᴊᴏɪɴ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟs! 📢

1️⃣ ғɪʀsᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "❤️ Movie update MG" ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ.  
2️⃣ ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "❤️🛍️ Online Loots Offers🛍️ "ᴊᴏɪɴ" ɪɴ ᴇᴀᴄʜ ᴄʜᴀɴɴᴇʟ.  
3️⃣ ᴀғᴛᴇʀ ᴊᴏɪɴɪɴɢ ᴀʟʟ ᴄʜᴀɴɴᴇʟs, ᴄʟɪᴄᴋ ᴛʜᴇ "♻️TRY AGAIN ♻️" 🔄 ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.

⚠️ ᴀʟʟ ᴄʜᴀɴɴᴇʟs ᴍᴜsᴛ ʙᴇ ᴊᴏɪɴᴇᴅ ғᴏʀ ᴀᴄᴄᴇss.

---

🎬 মুভি পেতে হলে অবশ্যই আমাদের অফিসিয়াল সব চ্যানেলে যুক্ত হতে হবে! 📢

1️⃣ প্রথমে নিচের "❤️ Movie update MG" বাটনে ক্লিক করুন।  
2️⃣ তারপর প্রতিটি চ্যানেলে গিয়ে "❤️🛍️ Online Loots Offers🛍️" বা "Join" বাটনে ক্লিক করুন।  
3️⃣ সব চ্যানেলে যুক্ত হওয়ার পর নিচের "♻️TRY AGAIN ♻️" 🔄 বাটনে ক্লিক করুন পরবর্তী এক্সেস পেতে।
