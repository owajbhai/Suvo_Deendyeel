...
1️⃣ ғɪʀsᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟs" ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ.  
2️⃣ ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ" ᴏʀ "ᴊᴏɪɴ" ɪɴ ᴇᴀᴄʜ ᴄʜᴀɴɴᴇʟ.  
3️⃣ ᴀғᴛᴇʀ ᴊᴏɪɴɪɴɢ ᴀʟʟ ᴄʜᴀɴɴᴇʟs, ᴄʟɪᴄᴋ ᴛʜᴇ "ʀᴇғʀᴇsʜ" 🔄 ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
...
1️⃣ প্রথমে নিচের "Join Update Channels" বাটনে ক্লিক করুন।  
2️⃣ তারপর প্রতিটি চ্যানেলে গিয়ে "Request to Join" বা "Join" বাটনে ক্লিক করুন।  
3️⃣ সব চ্যানেলে যুক্ত হওয়ার পর নিচের "Refresh" 🔄 বাটনে ক্লিক করুন পরবর্তী এক্সেস পেতে।
