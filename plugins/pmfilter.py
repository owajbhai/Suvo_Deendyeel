...
#Deendayal403
        ...
        buttons = [[           
            ...
            InlineKeyboardButton('🔥 Movie Update Notification 🔥', url="https://t.me/+LzFaWYx2Oe5kNjQ9"),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/super4crazy")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
            ...
            if not files:
                ...
                if settings["spell_check"]:
                  #  st=await message.reply_sticker(sticker="CAACAgQAAxkBAAEq2R9mipkiW9ACyj7oQXznwKTPHqNCXQACkBUAA3mRUZGx4GwLX9XCHgQ")
                    ai_sts = await message.reply_text('super4crazy 𝑪𝒉𝒆𝒄𝒌𝒊𝒏𝒈 𝒀𝒐𝒖𝒓 𝑺𝒑𝒆𝒍𝒍𝒊𝒏𝒈...')
